...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendMessage(View view){
        ...
        Intent intent = new Intent(this, SecondActivity.class);   // Explicit Intent, know which class to call
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == REPLY_REQUEST_CODE && resultCode == RESULT_OK){
            TextView textViewReply = findViewById(R.id.editTextReply);
            // Obtain reply from the Intent data
